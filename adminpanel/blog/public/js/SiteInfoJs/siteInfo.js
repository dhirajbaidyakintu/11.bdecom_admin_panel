...
function AboutUsUpdate(about) {
    ...
    axios.post('/AboutUsUpdate', {about:about}).then(function (response) {
...
function PrivacyPolicyUpdate(ploicy) {
    ...
    axios.post('/PrivacyPolicyUpdate', {ploicy:ploicy}).then(function (response) {
        if (response.status == 200) {
...
function PurchaseUpdate(purchase_guide) {
    ...
    axios.post('/PurchaseUpdate', {purchase_guide:purchase_guide}).then(function (response) {
        if (response.status == 200) {
...
function TermsUpdate(terms) {
    ...
    axios.post('/TermsUpdate', {terms:terms}).then(function (response) {
        if (response.status == 200) {
...
function AddressUpdate(address) {
    ...
    axios.post('/AddressUpdate', {address:address}).then(function (response) {
        if (response.status == 200) {
...
function AboutCompanyUpdate(about_company) {
    ...
    axios.post('/AboutCompanyUpdate', {about_company:about_company}).then(function (response) {
        if (response.status == 200) {
...
function DeliveryNoticeUpdate(delivery_notice) {
    ...
    axios.post('/DeliveryNoticeUpdate', {delivery_notice:delivery_notice}).then(function (response) {
        if (response.status == 200) {
...
function FacebookLinkUpdate(facebook_link) {
    ...
    axios.post('/FacebookLinkUpdate', {facebook_link:facebook_link}).then(function (response) {
        if (response.status == 200) {
...
function TwitterLinkUpdate(twitter_link) {
    ...
    axios.post('/TwitterLinkUpdate', {twitter_link:twitter_link}).then(function (response) {
        if (response.status == 200) {
...
function LinkedinLinkUpdate(instagram_link) {
    ...
    axios.post('/LinkedinLinkUpdate', {instagram_link:instagram_link}).then(function (response) {
        if (response.status == 200) {
...
function AndroidLinkUpdate(android_app_link) {
    ...
    axios.post('/AndroidLinkUpdate', {android_app_link:android_app_link}).then(function (response) {
        if (response.status == 200) {
...
function IosLinkUpdate(ios_app_link) {
    ...
    axios.post('/IosLinkUpdate', {ios_app_link:ios_app_link}).then(function (response) {
        if (response.status == 200) {
