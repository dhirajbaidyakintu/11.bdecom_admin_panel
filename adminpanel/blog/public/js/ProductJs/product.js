            ...
            if(response.status==200){
                ...
                $.each(JsonData, function (i, item) {
                    ...
                    $('<tr>').html(
                        ...
                        "Subcategory :"+JsonData[i].sub_category+"" +
                        "</th>" +
                        "<th class='th-sm'>" +
                        ...
                        "</th>" +
                        "<th class='th-sm'>" +
                        '<a class="productDetailsBtn" data-code="'+JsonData[i].product_code+'" data-category="'+JsonData[i].category+'"><i class="fas fa-edit"></i></a><br>' +
                        "<a class='productDeleteBtn' data-code='"+JsonData[i].product_code+"'><i class='fas fa-trash-alt'></i></a><br>" +
                        "</th>"
...
function ProductUpdateDetails(EditCode){
    ...
    axios.post('/getProductList',{code:EditCode}).then(function (response) {
        if(response.status==200){
            ...
            $('#SubCategory').val(JsonData[0].sub_category);
            $('#Remark').val(JsonData[0].remark);
            $('#ShopName').val(JsonData[0].shop_name);
            $('#ShopCode').val(JsonData[0].shop);
            $('#BrandName').val(JsonData[0].brand);
            $('#Star').val(JsonData[0].stars);
    ...
    axios.get(URL).then(function (response) {
        ...
        $.each(response.data, function(i, item) {
            $("<div class='col-3'>").html(
                ...
                "<button data-id="+ item['id']+" data-photo="+ item['location']+" class='btn SelectPhoto btn-sm btn-block btn-success'> Select</button>"
...
function getPhoto1() {
    ...
    axios.get(URL).then(function (response) {
        ...
        $.each(response.data, function(i, item) {
            $("<div class='col-3'>").html(
                "<img data-id="+ item['id']+" class='imgOnRow1' src=" + item['location'] + ">"+
                "<button data-id="+ item['id']+" data-photo="+ item['location']+" class='btn SelectPhoto1 btn-sm btn-block btn-success'> Select</button>"
...
function getPhoto2() {
    ...
    axios.get(URL).then(function (response) {
        ...
        $.each(response.data, function(i, item) {
            $("<div class='col-3'>").html(
                "<img data-id="+ item['id']+" class='imgOnRow1' src=" + item['location'] + ">"+
                "<button data-id="+ item['id']+" data-photo="+ item['location']+" class='btn SelectPhoto2 btn-sm btn-block btn-success'> Select</button>"
...
function getPhoto3() {
    ...
    axios.get(URL).then(function (response) {
        ...
        $.each(response.data, function(i, item) {
            $("<div class='col-3'>").html(
                "<img data-id="+ item['id']+" class='imgOnRow1' src=" + item['location'] + ">"+
                "<button data-id="+ item['id']+" data-photo="+ item['location']+" class='btn SelectPhoto3 btn-sm btn-block btn-success'> Select</button>"
...
function getPhoto4() {
    ...
    axios.get(URL).then(function (response) {
        ...
        $.each(response.data, function(i, item) {
            $("<div class='col-3'>").html(
                "<img data-id="+ item['id']+" class='imgOnRow1' src=" + item['location'] + ">"+
                "<button data-id="+ item['id']+" data-photo="+ item['location']+" class='btn SelectPhoto4 btn-sm btn-block btn-success'> Select</button>"
...
function getMainPhotoAdd() {
    ...
    axios.get(URL).then(function (response) {
        ...
        $.each(response.data, function(i, item) {
            $("<div class='col-3'>").html(
                "<img data-id="+ item['id']+" class='imgOnRow1' src=" + item['location'] + ">"+
                "<button data-id="+ item['id']+" data-photo="+ item['location']+" class='btn AddSelectPhoto btn-sm btn-block btn-success'> Select</button>"
...
function getPhoto1Add() {
    ...
    axios.get(URL).then(function (response) {
        ...
        $.each(response.data, function(i, item) {
            $("<div class='col-3'>").html(
                "<img data-id="+ item['id']+" class='imgOnRow1' src=" + item['location'] + ">"+
                "<button data-id="+ item['id']+" data-photo="+ item['location']+" class='btn AddSelectPhoto1 btn-sm btn-block btn-success'> Select</button>"
...
function getPhoto2Add() {
    ...
    axios.get(URL).then(function (response) {
        ...
        $.each(response.data, function(i, item) {
            $("<div class='col-3'>").html(
                "<img data-id="+ item['id']+" class='imgOnRow1' src=" + item['location'] + ">"+
                "<button data-id="+ item['id']+" data-photo="+ item['location']+" class='btn AddSelectPhoto2 btn-sm btn-block btn-success'> Select</button>"
...
function getPhoto3Add() {
    ...
    axios.get(URL).then(function (response) {
        ...
        $.each(response.data, function(i, item) {
            $("<div class='col-3'>").html(
                "<img data-id="+ item['id']+" class='imgOnRow1' src=" + item['location'] + ">"+
                "<button data-id="+ item['id']+" data-photo="+ item['location']+" class='btn AddSelectPhoto3 btn-sm btn-block btn-success'> Select</button>"
...
function getPhoto4Add() {
    ...
    axios.get(URL).then(function (response) {
        ...
        $.each(response.data, function(i, item) {
            $("<div class='col-3'>").html(
                "<img data-id="+ item['id']+" class='imgOnRow1' src=" + item['location'] + ">"+
                "<button data-id="+ item['id']+" data-photo="+ item['location']+" class='btn AddSelectPhoto4 btn-sm btn-block btn-success'> Select</button>"
