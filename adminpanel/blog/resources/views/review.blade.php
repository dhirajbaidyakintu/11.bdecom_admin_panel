...
@section('content')
    <div id="mainDivReview" class="container-fluid d-none table-color">
        <div class="col-md-12">
            <h4 class="text-center text-success">REVIEW LIST</h4>
        </div>
        <div class="row">
            <div class="col-md-12 p-5">
                <table id="reviewDataTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <th class="th-sm"><strong>Reviewer Photo</strong></th>
                        <th class="th-sm"><strong>Reviewer Name</strong></th>
                        <th class="th-sm"><strong>Reviewer Rating</strong></th>
                        <th class="th-sm"><strong>Reviewer Comments</strong></th>
                ...
                if (response.status = 200) {
                    ...
                    $.each(jsonData, function(i, item) {
                        $('<tr>').html(
                            ...
                            "<td><img class='table-img' src=" + jsonData[i].reviewer_photo+"></td>" +
                            "<td>" + jsonData[i].reviewer_name + "</td>" +
                            "<td>" + jsonData[i].reviewer_rating + "</td>" +
                            "<td>" + jsonData[i].reviewer_comments + "</td>" +
